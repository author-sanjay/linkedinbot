...
def indeed(namesofcompanyapplying, preferedjobtitle):
    ...
    time.sleep(3)
    loginemail = driver.find_element(by="xpath",
                                     value='/html/body/div/div[2]/main/div/div/div[2]/div/form/div/span/input')
    ...
    # login complete
    links = []
    # links.append("https://in.indeed.com/jobs?q=react+js+developer&l=&vjk=2a12b9acf746f367")
    ...
    for i in links:
        ...
        try:
            ...
            try:
                ...
                updateresume = driver.find_element(by="xpath",
                                                   value='//*[@id="resume-display-content"]/div/label/input').send_keys(
                    file)
                time.sleep(2)
